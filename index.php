...
<main role="main">
    ...
    <section class="jumbotron text-center">
        <div class="container pt-lg-5 pl-5 px-5">
            ...
            <p>
                <?php if ($isSessionExists) { ?>
                <a href="app/models/Booking.php" class="btn btn-success my-2" data-toggle="modal" data-target=".book-now-modal-lg">Book now<i class="fas fa-angle-double-right ml-1"></i></a>
                <?php } else { ?>
                <a href="app/models/Booking.php" class="btn btn-success my-2" data-toggle="modal" data-target=".sign-in-to-book-modal">Book now<i class="fas fa-angle-double-right ml-1"></i></a>
                <?php } ?>
            </p>
        </div>
    </section>
